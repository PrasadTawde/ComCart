                            ...
                            <div class="col-lg-6 col-md-8 u-s-m-b-30">
                                <div class="l-f-o">
                                    <div class="l-f-o__pad-box">
                                        ...
                                        <form class="l-f-o__form" id="login_form" method="post" action="{{ route('login') }}">
                                            @csrf
                                            ...
                                            <div class="u-s-m-b-30">
                                                ...
                                                <input class="input-text input-text--primary-style" type="text" id="email" name="email" placeholder="Enter E-mail" value="{{ old('email') }}"></div>
                                            <div class="u-s-m-b-30">
