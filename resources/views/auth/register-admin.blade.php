			...
			<div class="login-form">
                <form method="post" action="{{ route('register-admin') }}">
                    ...
                    <div class="form-action">
                        <a href="/login-admin" id="show-signin" class="btn btn-danger btn-rounded btn-login mr-3">Cancel</a>
                        <button class="btn btn-primary btn-rounded btn-login" type="submit">Sign Up</button>
                    </div>
                </form>
			</div>
		</div>
