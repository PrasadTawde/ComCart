                                    ...
                                    <div class="product-m">
                                        <div class="product-m__thumb">
                                            ...
                                            <div class="product-m__add-cart">
                                                ...
                                                <!-- <a class="btn--e-brand" href="/add-to-cart/">Add to Cart</a></div> -->
                                            </div>
                                            <div class="product-m__content">
                                                ...
                                                <div class="product-m__hover">
                                                    <a class="btn btn-sm btn-orange" onclick="location.href='/auction-product-details/{{$product->id}}'"> submit a bid</a>
                                                    <div class="product-m__preview-description" style="margin-top: 10px;">
