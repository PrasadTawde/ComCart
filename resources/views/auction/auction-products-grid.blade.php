                                            ...
                                            <li class="has-list">
                                                ...
                                                <ul style="display:block">
                                                    <li class="has-list ">
                                                        ...
                                                        <a href="{{ route('category',['mobile'])}}">MOBILES</a>

                                                        <span class="js-shop-category-span fas fa-plus u-s-m-l-6 {{ (request()->is('category/mobile-phones*')) ? 'is-expanded' : '' }}"></span>
                                                        <ul style="display:block">
                                                            <li>
                                            ...
                                            <div class="product-m__content">
                                                ...
                                                <div class="product-m__hover">
                                                    <div class="product-m__preview-description">
                                                        ...
                                                        <div class="product- __price" style="margin-bottom:10px">

                                                            <div class="product-m__name">
                                                                <a href="#"> Current Highest bid</a>
                                                            </div>
                                                            ₹10,000
                                                        </div>

                                                        <a class="btn btn-sm btn-orange" onclick="location.href='/auction-product-details'"> submit a bid</a>
