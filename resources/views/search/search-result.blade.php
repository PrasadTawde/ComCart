                    ...
                    <div class="shop-p">
                        <div class="shop-p__toolbar u-s-m-b-30">
                            <div class="shop-p__meta-wrap u-s-m-b-60">
                                ...
                                <span class="shop-p__meta-text-1">FOUND {{sizeof($result)}} RESULTS</span>
                            ...
                            <div class="shop-p__tool-style">
                                ...
                                <form>
                                    <div class="tool-style__form-wrap">
                                        ...
                                        <div class="u-s-m-b-8"><select class="select-box select-box--transparent-b-2" name="sortby">
                                                <option selected vlaue="newest">Sort By: Newest Items</option>
                                                <option vlaue="latest"> Sort By: Latest Items </option>
                                                <option vlaue="bestSelling">Sort By: Best Selling</option>
                                                <option vlaue="bestRating">Sort By: Best Rating</option>
                                                <option vlaue="lowestPrice">Sort By: Lowest Price</option>
                                                <option vlaue="highestPrice">Sort By: Highest Price</option>
                                            </select></div>
                                    </div>
                                </form>
                            </div>
                                    ...
                                    <div class="product-m">
                                        <div class="product-m__thumb">
                                            ...
                                            <a class="aspect aspect--bg-grey aspect--square u-d-block" href="product-detail.html">
                                                ...
                                                <img class="aspect__img" src="/fetch_image_1/{{ $res->id }}" alt=""></a>
                                        ...
                                        <div class="product-m__content">
                                            ...
                                            <div class="product-m__name">
                                                ...
                                                <a href="product-detail.html">{{$res->title}}</a>
                                            </div>
                                            ...
                                            <div class="product-m__price">Rs.{{$res->price}}</div>
