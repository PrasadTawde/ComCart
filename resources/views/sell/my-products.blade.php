                                    ...
                                    <div class="dash__box dash__box--shadow dash__box--bg-white dash__box--radius u-s-m-b-30">
                                        <div class="dash__pad-2">
                                            <div class="dash__address-header">
                                                <h1 class="dash__h1">My Products</h1>
                                            </div>
                                        </div>
                                        <div class="dash__table-2-wrap gl-scroll">
                                            <table class="dash__table-2">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <a class="address-book-edit btn--e-transparent-platinum-b-2" href="/product-edit/{{ $product->id }}">Edit</a>
                                                            <a class="mini-product__delete-link far fa-trash-alt" href="/product-delete/{{ $product->id }}"></a>
                                                        </td>
                                                        <td>{{$product->title}}</td>
